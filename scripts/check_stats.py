"""Check statistics of ground truth vs prediction."""
...
def check_gt_stats() -> None:  # noqa: PLR0915
    ...
    _, axes = plt.subplots(
        num_samples_to_plot * num_rows_per_sample, 5, figsize=(20, 4 * num_samples_to_plot * num_rows_per_sample)
    )
    ...
    for i in range(num_samples_to_plot):
        ...
        # --- FFT PLOTS ---
        def compute_log_fft(img: np.ndarray) -> np.ndarray:
            f = np.fft.fft2(img)
